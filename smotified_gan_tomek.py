...
def gan_augment_with_existing_resampling(X_train, y_train, X_train_resampled, y_train_resampled,apply_tomek,
...
def gan_augment_with_existing_resampling(X_train, y_train, apply_tomek,
                                   n_epochs=200, batch_size=128, lr=0.00001):
    device = 'cuda' if torch.cuda.is_available() else 'cpu'
    input_dim = X_train.shape[1]
